...
To get started use an `A` or `CNAME` record pointing to the IP/FQDN of the machine with Teleport installed.

<Admonition type="tip" title="Tip">
You can use `dig` to make sure that DNS record is propagated:
